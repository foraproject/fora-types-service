(function() {
    ...
    */
    TypesService.prototype.constructModel = function*(obj, typeDefinition, options) {
    ...
    */
    TypesService.prototype.updateModel = function*(target, obj, typeDefinition, options) {
